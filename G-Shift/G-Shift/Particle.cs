...
//
// generic all-purpose Particle class
//
...
namespace G_Shift
{
    ...
    public class Particle
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            // seems correct
            spriteBatch.Draw(Texture, Position, sourceRectangle, Color,
                Angle, origin, Size, SpriteEffects.None, .99f);

            //spriteBatch.Draw(baseRectangle, pos, boss1HealthBar, Color.Blue, 0, origin, 1, SpriteEffects.None, 0.99f);

            // correct
            //spriteBatch.Draw(Texture, Position, sourceRectangle, Color, Angle, origin, 1, SpriteEffects.None, 0.99f);
        }
    }
}
